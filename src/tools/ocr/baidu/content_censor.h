...
namespace aip {
    ...
    public:
        ...
        std::string _user_defined =
            "https://aip.baidubce.com/rest/2.0/solution/v1/img_censor/user_defined";
            ...
            const std::map<std::string, std::string> & options)
        {
            ...
            Json::Value result =
                this->request(_user_defined, null, data, null);
